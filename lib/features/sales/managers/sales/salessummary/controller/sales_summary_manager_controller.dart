...
class SalesSummaryManagerController extends GetxController {
  ...
  void onInit() {
    ...
    fetchSalessummaryManager();
  }

  Future<void> fetchSalessummaryManager() async {
    final requestBody = {
    ...
    try {
      ...
      final response = await _restletService.fetchReportData(
        NetSuiteScripts.salessummarymanagerscriptId,
        requestBody,
      );
