...
class NewProductReport extends StatefulWidget {
  const NewProductReport({super.key});

  @override
  _NewProductReportState createState() => _NewProductReportState();
}

class _NewProductReportState extends State<NewProductReport>
    with SingleTickerProviderStateMixin {
  final NewProductSalesController newProductController =
  ...
  Widget build(BuildContext context) {
    final theme =  Theme.of(context);
    return Obx(() {
      final reportData = newProductController.salesreportData;
