...
import 'package:impal_desktop/features/services/credentials/warehouse_credentials.dart';
import 'package:netbridge/netbridge.dart';

class WarehouseRestletService {
  ...
  void init() async {
    Credentials credentials = Credentials(warehouseOAuthCredentials);
